...
foreach ($data as $row) {
    ...
    $armaskedData = maskData($row['CF_INS_PRENOM']);
    $frmaskedData = maskData($row['CF_INS_NOM']);
    $frmaskedData = maskData($row['CF_INS_EMAIL']);
    $frmaskedData = maskData($row['CF_INS_CIN']);
    ...
    $stmt->bindValue(':CF_INS_PRENOM', $armaskedData, PDO::PARAM_STR);
    $stmt->bindValue(':CF_INS_NOM', $armaskedData, PDO::PARAM_STR);
    $stmt->bindValue(':CF_INS_EMAIL', $armaskedData, PDO::PARAM_STR);
    $stmt->bindValue(':CF_INS_CIN', $frmaskedData, PDO::PARAM_STR);
