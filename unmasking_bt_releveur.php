...
if (isset($_POST['unmask'])) {
    ...
    foreach ($data as $row) {
        ...
        $arunmaskedData = unmaskData($row['BT_RELV_NOM_PRENOM_AR']);
        $frunmaskedData = unmaskData($row['BT_RELV_NOM_PRENOM_FR']);
        ...
        $stmt->bindValue(':BT_RELV_NOM_PRENOM_AR', $arunmaskedData, PDO::PARAM_STR);
        $stmt->bindValue(':BT_RELV_NOM_PRENOM_FR', $frunmaskedData, PDO::PARAM_STR);
