...
if (isset($_POST['unmask'])) {
    ...
    $stmt = $bdd->query('SELECT * FROM cd_abonne');
    ...
    foreach ($data as $row) {
        ...
        $sql = "UPDATE cf_abonne SET CF_INS_PRENOM = :CF_INS_PRENOM, CF_INS_NOM = :CF_INS_NOM, CF_INS_EMAIL = :CF_INS_EMAIL, CF_INS_CIN = :CF_INS_CIN WHERE RC_UR_CODE = :RC_UR_CODE";
